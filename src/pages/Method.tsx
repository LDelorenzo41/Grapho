          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-md">
              <div className="font-body text-lg text-gray-700 space-y-4 text-center">
                <p>
                  La graphothérapie est une démarche spécialisée dédiée à l’écriture manuscrite s’adressant  aux enfants, adolescents et adultes
                  rencontrant des difficultés graphiques : écriture lente, douloureuse, illisible ou fatigante.
                </p>
                <p>
                  Elle vise à restaurer une écriture fluide, efficace et sans douleur grâce à des exercices progressifs et adaptés
                  à chacun.
                </p>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-gradient-to-br from-blue-50 to-blue-100/50 rounded-xl p-6 shadow-md hover:shadow-lg transition-shadow">
              ...
              <p className="font-body text-gray-700 text-center">
                Lorsqu'écrire devient une épreuve, que les lettres s'emmêlent ou que la main se fatigue trop vite.
              </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-green-50 to-green-100/50 rounded-xl p-6 shadow-md hover:shadow-lg transition-shadow">
              ...
              <p className="font-body text-gray-700 text-center">
                Avec une écriture lente, trop rapide ou douloureuse. Quand l'écriture perd en lisibilité, que le rythme scolaire s'accélère ou que la confiance s'effrite.
              </p>
            </div>

            {/* Carte 3: Adultes & seniors */}
            <div className="bg-gradient-to-br from-purple-50 to-purple-100/50 rounded-xl p-6 shadow-md hover:shadow-lg transition-shadow">
              ...
              <p className="font-body text-gray-700 text-center">
                Souhaitant améliorer ou maintenir leur écriture. Retrouver le confort du geste, améliorer la lisibilité, ou simplement renouer avec le plaisir d'écrire à la main.
              </p>
            </div>
...
<div className="bg-gradient-to-br from-pink-50 to-pink-100/50 rounded-xl p-6 shadow-md hover:shadow-lg transition-shadow">
  ...
  <h3 className="font-title text-xl font-bold text-text mb-3 text-center">
    Troubles dys
  </h3>
          ...
          <div className="space-y-6 max-w-5xl mx-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
                ...
                <div className="md:col-span-10 p-6">
                  ...
                  <ul className="space-y-3 font-body text-gray-700">
                    ...
                    <li className="flex items-start">
                      <span className="text-primary mr-3 mt-1 font-bold">•</span>
                      <span>Le <strong>deuxième rendez-vous</strong> se déroule avec l'enfant seul. Il permet d'évaluer le geste graphique, la posture, la tenue du crayon et la motricité fine au travers de tests. Ce bilan sert à comprendre les origines des difficultés et à définir un plan de remédiation personnalisé ;</span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-primary mr-3 mt-1 font-bold">•</span>
                      <span>Le <strong>troisième rendez-vous</strong> est un rendez-vous de remise du bilan aux parents et à l'enfant, afin de discuter ensemble du plan de remédiation et d'un suivi adapté aux besoins de chacun.</span>
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-100 hover:shadow-xl transition-shadow">
              <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
                ...
                {/* Contenu à droite */}
                <div className="md:col-span-10 p-6">
                  <h3 className="font-title text-2xl font-bold text-text mb-4">Les séances de remédiation</h3>
                  <p className="font-body text-gray-700">
                    Les séances de remédiation sont ensuite construites comme des moments de <strong>détente et de progression</strong> : on bouge, on respire, on trace, on joue avec les formes et les mouvements. Petit à petit, l'écriture devient plus fluide, plus souple… et souvent, plus joyeuse aussi.
                  </p>
                </div>
              </div>
            </div>
